...
<head>
  ...
  <title>Konasam Praveen Kumar — Portfolio</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .hero{display:grid;grid-template-columns:1fr 400px;align-items:center;gap:40px;padding-top:30px}
    .intro h1{font-size:36px;margin:0 0 8px 0;font-weight:800}
    .intro p{color:var(--muted);margin:0}

    .photo-wrap{display:flex;align-items:center;justify-content:center}
    .photo{
      width:340px;height:340px;border-radius:50%;overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,0.6);background:linear-gradient(90deg,#0f0f0f,#131313);display:flex;align-items:center;justify-content:center;
    }
    ...
    <div class="container">
      <section class="hero">
        ...
        <div class="photo-wrap">
          <div class="photo">
            <img src="praveen.jpg" alt="Praveen Photo">
          </div>
        </div>
      </section>
